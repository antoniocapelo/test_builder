...
import { DragDropContext, Droppable, Draggable, DropResult } from "@/components/survey/dnd";
...
export const SurveyForm: React.FC<SurveyFormProps> = ({
  ...
  const onDragEnd = (result: DropResult) => {
    ...
    setSurvey({
      ...survey,
      questions: reorder(survey.questions, result.source.index, result.destination.index),
    });
  };
